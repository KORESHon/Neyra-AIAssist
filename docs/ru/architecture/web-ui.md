...
Полное real-time совпадение с Event Bus для всех действий UI запланировано на **этап C** (двусторонний WebSocket-мост — см. `PLAN.md`). Сейчас панель в основном использует HTTP `/v1`.
